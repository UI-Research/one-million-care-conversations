...
challenges question `q2a`, that means columns such as `q2a_unaffordable` and
`q2a_time_flex`.
...
the start of the cell. The result is the same either way.
...
The first two rows of the raw table above, after this step, for the
challenges question `q2a`. The packed cell has become ten TRUE/FALSE columns
plus the "Other" text.
