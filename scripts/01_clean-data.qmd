...
A person who ticks answers from more than one group is routed to the first
that applies, in that order. We checked this against the data: a person
eligible for both `past` and `future` was shown only the `past` questions.
